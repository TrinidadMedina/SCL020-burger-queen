...
export function Order({ order, handleDelivery }) {
  ...
  return (
    <div className="bg-gray-100 font-bold shadow-lg text-xl rounded m-2 h-[250px] flex-col justify-between" > {/*bg-gray-100*/}
      ...
      <div className="w-52 h-[149px] flex-col bg-white overflow-auto rounded pt-1">  

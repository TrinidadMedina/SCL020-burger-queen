...
export function OrderKitchen({ order, handleReady }) {
  ...
  return (
    <div key={order.oderId} className="bg-gray-100 flex flex-col m-4 shadow-lg">
      ...
      <button onClick={()=>{handleReady(order.orderId)}} className=' bg-gray-500 hover:bg-blue-700  place-content-center text-white font-bold py-2 px-4 m-4 mt-3 rounded justify-self-end'>Listo</button>
    </div >
  )
}
